...
import { BarChart3, CalendarDays, CreditCard, LayoutDashboard, Menu, MessageSquareText, Package, Settings, Users, X, Clock3, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] md:grid md:grid-cols-[250px_1fr]">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[250px] flex-col bg-[#0b1f3a] p-5 text-white md:flex">
        ...
        <Nav />
        <div className="mt-auto rounded-xl border border-white/10 bg-white/5 p-3 text-xs leading-5 text-slate-300"><BarChart3 className="mb-2 text-[#d4a72c]" size={18} />Built for fast WhatsApp lead follow-up.</div>
      </aside>
