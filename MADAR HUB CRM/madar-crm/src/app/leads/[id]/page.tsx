  ...
  return <>
    ...
    <div className="grid gap-4 xl:grid-cols-[1fr_360px]">
      ...
      <aside className="space-y-4"><section className="card p-5"><h2 className="font-bold text-[#0b1f3a]">Current stage</h2><div className="mt-3"><StatusBadge status={lead.status} /></div><p className="mt-3 text-sm leading-6 text-slate-500">Last updated {formatDate(lead.updatedAt, true)}.</p></section>
        <section className="card p-5"><h2 className="mb-1 flex items-center gap-2 font-bold text-[#0b1f3a]"><Bot size={18} className="text-[#d4a72c]" />Continue Conversation</h2><p className="mb-4 text-sm text-slate-500">Paste new WhatsApp messages and AI will draft a contextual reply.</p><textarea className="field min-h-24 resize-y text-sm leading-6" placeholder="Paste the latest WhatsApp conversation bits here..."/><div className="mt-3"><button className="btn btn-gold min-w-32">Generate Reply</button></div></section>
