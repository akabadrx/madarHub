  ...
  return <>
    ...
    <div className="grid gap-4 xl:grid-cols-[1fr_360px]">
      ...
      <aside className="space-y-4">
        <div className="card p-5"><h2 className="mb-1 font-bold text-[#0b1f3a]">Continue Conversation</h2><p className="text-sm text-slate-500">Paste new WhatsApp messages and AI will draft a contextual reply.</p></div>
      </aside>
    </div>
  </>;
}
